...
public class GCTest1 {
    ...
    /*
    需要配置JVM参数:-verbose:gc -Xms20M -Xmx20M -Xmn10M -XX:+PrintGCDetails -XX:SurvivorRatio=8
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         （新生代总的容量）] 8144K（堆收集前）->6872K（堆收集后）(19456K)（堆总的容量）, 0.0087417 secs（所用时间）] [Times: user（用户态收集所用时间）=0.02 sys=0.02系统态收集所用时间）, real=0.01 secs]
         ...
         hello world
         Heap
         PSYoungGen(新生代垃圾收集器)      total 9216K, used 2287K [0x00000000ff600000, 0x0000000100000000, 0x0000000100000000)
         eden space 8192K, 27% used [0x00000000ff600000,0x00000000ff83be00,0x00000000ffe00000)
         from space 1024K, 0% used [0x00000000ffe00000,0x00000000ffe00000,0x00000000fff00000)
         to   space 1024K, 0% used [0x00000000fff00000,0x00000000fff00000,0x0000000100000000)
         ParOldGen(老年代垃圾收集器)       total 10240K, used 6774K [0x00000000fec00000, 0x00000000ff600000, 0x00000000ff600000)
